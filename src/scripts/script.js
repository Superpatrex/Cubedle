...
Cube.prototype.rotateSides = function() {
  ...
  //   this.sides[0].getElementsByClassName('tile')[0].style[userPrefix.js + 'Transform'] = 'rotate(' + (viewport.positionX + viewport.torqueX) + 'deg)';
  //   this.sides[5].getElementsByClassName('tile')[0].style[userPrefix.js + 'Transform'] = 'rotate(' + -(viewport.positionX + 180 + viewport.torqueX) + 'deg)';
  // } else {
  //   this.sides[0].getElementsByClassName('tile')[0].style[userPrefix.js + 'Transform'] = 'rotate(' + (viewport.positionX - viewport.torqueX) + 'deg)';
  //   this.sides[5].getElementsByClassName('tile')[0].style[userPrefix.js + 'Transform'] = 'rotate(' + -(viewport.positionX + 180 - viewport.torqueX) + 'deg)';
  // }
...
Cube.prototype.upsideDown = function(obj) {
  ...
  while(i > 0 && --i) {
    this.sides[i].getElementsByClassName('tile')[0].style[userPrefix.js + 'Transform'] = 'rotate(' + deg + ')';
  }
